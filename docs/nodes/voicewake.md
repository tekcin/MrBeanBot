...
MrBeanBot treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.MrBeanBot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["mrbeanbot", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
