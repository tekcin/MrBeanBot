...
This page ties together how MrBeanBot handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. MrBeanBot keeps a
...
MrBeanBot separates the **prompt body** from the **command body**:
...
MrBeanBot can expose or hide model reasoning:
