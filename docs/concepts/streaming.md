...
MrBeanBot has two separate “streaming” layers:
...
When block streaming is enabled, MrBeanBot can **merge consecutive block chunks**
...
When draft streaming is active, MrBeanBot disables block streaming for that reply to avoid double-streaming.
