---
summary: "Schema-accurate configuration examples for common MrBeanBot setups"
read_when:
  - Learning how to configure MrBeanBot
  - Looking for configuration examples
  - Setting up MrBeanBot for the first time
---
...
Save to `~/.MrBeanBot/MrBeanBot.json` and you can DM the bot from that number.
...
```json5
{
  ...
  session: {
    ...
    store: "~/.MrBeanBot/agents/default/sessions/sessions.json",
  ...
  cron: {
    enabled: true,
    store: "~/.MrBeanBot/cron/cron.json",
    maxConcurrentRuns: 2
  },
