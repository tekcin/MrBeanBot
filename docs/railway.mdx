...
Deploy MrBeanBot on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/MrBeanBot-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/MrBeanBot` — Control UI

## What you get

- Hosted MrBeanBot Gateway + Control UI
...
- `MRBEANBOT_STATE_DIR=/data/.MrBeanBot` (recommended)
- `MRBEANBOT_WORKSPACE_DIR=/data/workspace` (recommended)
- `MRBEANBOT_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your MrBeanBot state + workspace so you can migrate to another host without losing config or memory.
