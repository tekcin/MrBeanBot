...
read_when:
  - You want MrBeanBot to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables MrBeanBot to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`MrBeanBot onboard`) and `MrBeanBot channels add` list optional channel plugins.
...
```bash
MrBeanBot plugins install @MrBeanBot/nostr
```

Use a local checkout (dev workflows):

```bash
MrBeanBot plugins install --link <path-to-MrBeanBot>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "MrBeanBot",
        "displayName": "MrBeanBot",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "MrBeanBot@example.com",
        "lud16": "MrBeanBot@example.com"
      }
    }
  }
}
