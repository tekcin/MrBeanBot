...
- Install via CLI: `MrBeanBot plugins install @MrBeanBot/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `MrBeanBot plugins install ./extensions/zalo`
   - From npm (if published): `MrBeanBot plugins install @MrBeanBot/zalo`
...
- Approve via:
  - `MrBeanBot pairing list zalo`
  - `MrBeanBot pairing approve zalo <CODE>`
...
- Example: `MrBeanBot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `MrBeanBot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `MrBeanBot logs --follow`
