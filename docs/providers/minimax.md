---
summary: "Use MiniMax M2.1 in MrBeanBot"
read_when:
  - You want MiniMax models in MrBeanBot
...
Configure manually via `MrBeanBot.json`:
...
- Use `MrBeanBot models list` and `MrBeanBot models set minimax/MiniMax-M2.1` to switch.
...
- Running `MrBeanBot configure` and selecting **MiniMax M2.1**, or
