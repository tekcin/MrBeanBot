---
summary: "Model providers (LLMs) supported by MrBeanBot"
read_when:
...
MrBeanBot can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `MrBeanBot onboard`).
