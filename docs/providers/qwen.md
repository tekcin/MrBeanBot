---
summary: "Use Qwen OAuth (free tier) in MrBeanBot"
read_when:
  - You want to use Qwen with MrBeanBot
...
```bash
MrBeanBot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, MrBeanBot will sync credentials
