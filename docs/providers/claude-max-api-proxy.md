...
You can point MrBeanBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or MrBeanBot
...
- [Anthropic provider](/providers/anthropic) - Native MrBeanBot integration with Claude setup-token or API keys
