...
MrBeanBot ships three update channels:
...
When you **explicitly** switch channels with `--channel`, MrBeanBot also aligns
the install method:
...
When you switch channels with `MrBeanBot update`, MrBeanBot also syncs plugin sources:
