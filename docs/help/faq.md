---
summary: "Frequently asked questions about MrBeanBot setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up MrBeanBot?](#whats-the-recommended-way-to-install-and-set-up-MrBeanBot)
...
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  ...
  - [Windows install says git not found or MrBeanBot not recognized](#windows-install-says-git-not-found-or-MrBeanBot-not-recognized)
  ...
  - [If I buy a Mac mini to run MrBeanBot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-MrBeanBot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different MrBeanBots?](#can-multiple-people-use-one-whatsapp-number-with-different-MrBeanBots)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run MrBeanBot on a dedicated machine?](#how-important-is-it-to-run-MrBeanBot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run MrBeanBot in a VM and what are the requirements](#can-i-run-MrBeanBot-in-a-vm-and-what-are-the-requirements)
- [What is MrBeanBot?](#what-is-MrBeanBot)
  - [What is MrBeanBot, in one paragraph?](#what-is-MrBeanBot-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for MrBeanBot](#what-are-the-top-five-everyday-use-cases-for-MrBeanBot)
  - [Can MrBeanBot help with lead gen outreach ads and blogs for a SaaS](#can-MrBeanBot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can MrBeanBot run tasks on a schedule or continuously in the background?](#can-MrBeanBot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with MrBeanBot saved locally?](#is-all-data-used-with-MrBeanBot-saved-locally)
  - [Where does MrBeanBot store its data?](#where-does-MrBeanBot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall MrBeanBot?](#how-do-i-completely-uninstall-MrBeanBot)
...
- [Config basics](#config-basics)
  ...
  - [Can the MrBeanBot browser run headless?](#can-the-MrBeanBot-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two MrBeanBots talk to each other (local + VPS)?](#can-two-MrBeanBots-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does MrBeanBot load environment variables?](#how-does-MrBeanBot-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of MrBeanBots one CEO and many agents](#is-there-a-way-to-make-a-team-of-MrBeanBots-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset MrBeanBot but keep it installed?](#how-do-i-completely-reset-MrBeanBot-but-keep-it-installed)
  ...
  - [Why doesn’t MrBeanBot reply in a group?](#why-doesnt-MrBeanBot-reply-in-a-group)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `MrBeanBot gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-MrBeanBot-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `MrBeanBot gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-MrBeanBot-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run MrBeanBot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-MrBeanBot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart MrBeanBot?](#i-closed-my-terminal-on-windows-how-do-i-restart-MrBeanBot)
  ...
  - [ELI5: `MrBeanBot gateway restart` vs `MrBeanBot gateway`](#eli5-MrBeanBot-gateway-restart-vs-MrBeanBot-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose MrBeanBot to inbound DMs?](#is-it-safe-to-expose-MrBeanBot-to-inbound-dms)
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/MrBeanBot/MrBeanBot-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ...
   MrBeanBot health --verbose   # shows the target URL + config path on errors
   ```
...
https://github.com/MrBeanBot/MrBeanBot/issues
https://github.com/MrBeanBot/MrBeanBot/pulls
...
What they do:
- `MrBeanBot status`: quick snapshot of gateway/agent health + basic config.
- `MrBeanBot models status`: checks provider auth + model availability.
- `MrBeanBot doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `MrBeanBot status --all`, `MrBeanBot logs --follow`,
`MrBeanBot gateway status`, `MrBeanBot health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up MrBeanBot
...
If you don’t have a global install yet, run it via `pnpm MrBeanBot onboard`.
...
- If it asks for auth, run `MrBeanBot dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `MRBEANBOT_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**
- **Tailscale Serve** (recommended): keep bind loopback, run `MrBeanBot gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `MrBeanBot gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `MrBeanBot dashboard`.
...
under `~/.MrBeanBot/` (for example `~/.MrBeanBot/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-MrBeanBot-store-its-data),
...
https://github.com/MrBeanBot/MrBeanBot/blob/main/CHANGELOG.md
...
https://github.com/MrBeanBot/MrBeanBot/tree/main/docs
...
### Windows install says git not found or MrBeanBot not recognized
...
**2) MrBeanBot is not recognized after install**
...
### How do I install MrBeanBot on Linux
...
### How do I install MrBeanBot on a VPS
...
```bash
MrBeanBot update
MrBeanBot update status
MrBeanBot update --channel stable|beta|dev
MrBeanBot update --tag <dist-tag|version>
MrBeanBot update --no-restart
```

If you must automate from an agent:

```bash
MrBeanBot update --yes --no-restart
MrBeanBot gateway restart
```
...
`MrBeanBot onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run MrBeanBot with **API keys** (Anthropic/OpenAI/others) or with
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `MrBeanBot models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `MrBeanBot models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. MrBeanBot no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so MrBeanBot can keep replying while a provider is rate‑limited.
...
MrBeanBot supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. MrBeanBot fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `MrBeanBot.json`.

Steps:
1) Enable the plugin: `MrBeanBot plugins enable google-gemini-cli-auth`
2) Login: `MrBeanBot models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. MrBeanBot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. MrBeanBot runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. MrBeanBot’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run MrBeanBot can I connect it to my MacBook Pro
...
- Use `MrBeanBot nodes status` / `MrBeanBot nodes list` to see it.
...
- DM your bot, then run `MrBeanBot logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different MrBeanBots
...
If you run MrBeanBot via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
**MrBeanBot-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run MrBeanBot on a dedicated machine
...
MrBeanBot is lightweight. For a basic Gateway + one chat channel:
...
### Can I run MrBeanBot in a VM and what are the requirements
...
### What is MrBeanBot in one paragraph

MrBeanBot is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

MrBeanBot is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for MrBeanBot
...
### Can MrBeanBot help with lead gen outreach ads and blogs for a SaaS
...
MrBeanBot draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

MrBeanBot is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use MrBeanBot when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.MrBeanBot/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.MrBeanBot/MrBeanBot.json`). Precedence is `<workspace>/skills` > `~/.MrBeanBot/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.
...
Checklist:
- Confirm cron is enabled (`cron.enabled`) and `MRBEANBOT_SKIP_CRON` is not set.
- Check the Gateway is running 24/7 (no sleep/restarts).
- Verify timezone settings for the job (`--tz` vs host timezone).

Debug:
```bash
MrBeanBot cron run <jobId> --force
MrBeanBot cron runs --id <jobId> --limit 50
```
...
Not directly. macOS skills are gated by `metadata.MrBeanBot.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-MrBeanBot-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. MrBeanBot can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.MrBeanBot/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: {"MrBeanBot":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (MrBeanBot only needs stdio). See [iMessage](/channels/imessage).
...
MrBeanBot memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

MrBeanBot also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, MrBeanBot auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, MrBeanBot
prefers `local`.
...
### Is all data used with MrBeanBot saved locally

No - **MrBeanBot’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.MrBeanBot` + your workspace directory).
...
### Where does MrBeanBot store its data

Everything lives under `$MRBEANBOT_STATE_DIR` (default: `~/.MrBeanBot`):

| Path | Purpose |
|------|---------|
| `$MRBEANBOT_STATE_DIR/MrBeanBot.json` | Main config (JSON5) |
| `$MRBEANBOT_STATE_DIR/credentials/oauth.json` | Legacy OAuth import (copied into auth profiles on first use) |
| `$MRBEANBOT_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys) |
| `$MRBEANBOT_STATE_DIR/agents/<agentId>/agent/auth.json` | Runtime auth cache (managed automatically) |
| `$MRBEANBOT_STATE_DIR/credentials/` | Provider state (e.g. `whatsapp/<accountId>/creds.json`) |
| `$MRBEANBOT_STATE_DIR/agents/` | Per‑agent state (agentDir + sessions) |
| `$MRBEANBOT_STATE_DIR/agents/<agentId>/sessions/` | Conversation history & state (per agent) |
| `$MRBEANBOT_STATE_DIR/agents/<agentId>/sessions/sessions.json` | Session metadata (per agent) |
...
These files live in the **agent workspace**, not `~/.MrBeanBot`.
...
Do **not** commit anything under `~/.MrBeanBot` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall MrBeanBot
...
`workspace` to the repo root. The MrBeanBot repo is just source code; keep the
...
MrBeanBot reads an optional **JSON5** config from `$MRBEANBOT_CONFIG_PATH` (default: `~/.MrBeanBot/MrBeanBot.json`):
...
Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `MRBEANBOT_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `MrBeanBot doctor --generate-gateway-token`.
...
key. **Recommended:** run `MrBeanBot configure --section web` to store it in
...
- Daemons read env vars from `~/.MrBeanBot/.env` (or the service environment).
...
### Can the MrBeanBot browser run headless
...
5) Approve the node on the Gateway:
   ```bash
   MrBeanBot nodes pending
   MrBeanBot nodes approve <requestId>
   ```
...
Check the basics:
- Gateway is running: `MrBeanBot gateway status`
- Gateway health: `MrBeanBot status`
- Channel health: `MrBeanBot channels status`
...
### Can two MrBeanBots talk to each other local VPS
...
`MrBeanBot agent --message ... --deliver`, targeting a chat where the other bot
listens. If one bot is on a remote VPS, point your CLI at that remote Gateway
via SSH/Tailscale (see [Remote access](/gateway/remote)).

Example pattern (run from a machine that can reach the target Gateway):
```bash
MrBeanBot agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
Recover:
- Restore from backup (git or a copied `~/.MrBeanBot/MrBeanBot.json`).
- If you have no backup, re-run `MrBeanBot doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `MrBeanBot config set` for small changes.
- Use `MrBeanBot configure` for interactive edits.
...
```bash
MrBeanBot gateway --tailscale serve
```
...
### How does MrBeanBot load environment variables

MrBeanBot reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:
...
1) Put the missing keys in `~/.MrBeanBot/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`MRBEANBOT_LOAD_SHELL_ENV=1`, `MRBEANBOT_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`MrBeanBot models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means MrBeanBot won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1) Put the token in `~/.MrBeanBot/.env`:
   ```
...
### Is there a way to make a team of MrBeanBots one CEO and many agents
...
### How do I completely reset MrBeanBot but keep it installed
...
```bash
MrBeanBot reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `MRBEANBOT_PROFILE`), reset each state dir (defaults are `~/.MrBeanBot-<profile>`).
- Dev reset: `MrBeanBot gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), MrBeanBot skips the heartbeat run to save API calls.
...
No. MrBeanBot runs on **your own account**, so if you’re in the group, MrBeanBot can see it.
...
```bash
MrBeanBot directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt MrBeanBot reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.MrBeanBot/agents/<agentId>/sessions/`.
...
- Use `MrBeanBot doctor` to spot stray workspaces and profile mismatches.
...
MrBeanBot’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, MrBeanBot currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `MrBeanBot models set ...` (updates just model config)
- `MrBeanBot configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.MrBeanBot/MrBeanBot.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `MrBeanBot doctor` to repair.
...
Yes. MrBeanBot ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.MrBeanBot/agents/<agentId>/agent/auth-profiles.json
```

Fix options:
- Run `MrBeanBot agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so MrBeanBot can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.MrBeanBot/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.MrBeanBot/agent/*` (migrated by `MrBeanBot doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.MrBeanBot/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `MrBeanBot models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `MrBeanBot models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `MrBeanBot models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.MrBeanBot/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    MrBeanBot models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), MrBeanBot will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: MrBeanBot now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
MrBeanBot uses provider‑prefixed IDs like:
...
MrBeanBot may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `MrBeanBot models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
MrBeanBot models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
MrBeanBot models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
MrBeanBot models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
MrBeanBot models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

MrBeanBot supports both:
...
```
--port > MRBEANBOT_GATEWAY_PORT > gateway.port > default 18789
```

### Why does MrBeanBot gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `MrBeanBot gateway status` and trust these lines:
- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does MrBeanBot gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `MRBEANBOT_STATE_DIR` mismatch).

Fix:
```bash
MrBeanBot gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

MrBeanBot enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `MrBeanBot gateway --port <port>`.

### How do I run MrBeanBot in remote mode client connects to a Gateway elsewhere
...
Notes:
- `MrBeanBot gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `MrBeanBot.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:
- Fastest: `MrBeanBot dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `MrBeanBot doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `MRBEANBOT_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `MrBeanBot status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `MRBEANBOT_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):
- Use `MrBeanBot --profile <name> …` per instance (auto-creates `~/.MrBeanBot-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `MrBeanBot --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.MrBeanBot.*`, `MrBeanBot-gateway-<profile>.service`, `MrBeanBot Gateway (<profile>)`).
...
```
MrBeanBot tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/MrBeanBot/MrBeanBot-YYYY-MM-DD.log
```
...
- macOS: `$MRBEANBOT_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.MrBeanBot/logs/...`; profiles use `~/.MrBeanBot-<profile>/logs/...`)
- Linux: `journalctl --user -u MrBeanBot-gateway[-<profile>].service -n 200 --no-pager`
...
If you run the gateway manually, `MrBeanBot gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart MrBeanBot
...
1) Is the Gateway running? `MrBeanBot gateway status`
2) Is the Gateway healthy? `MrBeanBot status`
3) Does the UI have the right token? `MrBeanBot dashboard`
...
```bash
MrBeanBot channels status
MrBeanBot channels logs --channel telegram
```
...
### ELI5 MrBeanBot gateway restart vs MrBeanBot gateway

- `MrBeanBot gateway restart`: restarts the **background service** (launchd/systemd).
- `MrBeanBot gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `MrBeanBot gateway` when
...
```bash
MrBeanBot message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose MrBeanBot to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `MrBeanBot pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `MrBeanBot pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `MrBeanBot doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. MrBeanBot only replies to chats it receives or to explicit sends you trigger.
...
MrBeanBot blocks **cross‑provider** messaging by default. If a tool call is bound
