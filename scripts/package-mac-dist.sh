...
# Output:
# - dist/MrBeanBot.app
# - dist/MrBeanBot-<version>.zip
# - dist/MrBeanBot-<version>.dmg
...
APP="$ROOT_DIR/dist/MrBeanBot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/MrBeanBot-$VERSION.zip"
DMG="$ROOT_DIR/dist/MrBeanBot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/MrBeanBot-$VERSION.notary.zip"
