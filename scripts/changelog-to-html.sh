...
if [[ -z "$version_content" ]]; then
  echo "<h2>MrBeanBot $VERSION</h2>"
  echo "<p>Latest MrBeanBot update.</p>"
  echo "<p><a href=\"https://github.com/MrBeanBot/MrBeanBot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
