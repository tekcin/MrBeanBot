---
name: bluebubbles
description: Build or update the BlueBubbles external channel plugin for MrBeanBot (extension package, REST send/probe, webhook inbound).
---
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `MrBeanBot/plugin-sdk` helpers.
