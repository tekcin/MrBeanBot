...
export async function finalizeOnboardingWizard(options: FinalizeOnboardingOptions) {
  ...
  await prompter.note(
    [
      ...
      "Docs: https://docs.mrbeanbot.com/concepts/agent-workspace",
    ].join("\n"),
    "Workspace backup",
  );

  await prompter.note(
    "Running agents on your computer is risky — harden your setup: https://docs.mrbeanbot.com/security",
    "Security",
  );
  ...
  await prompter.note(
    'What now: https://mrbeanbot.com/showcase ("What People Are Building").',
    "What now",
  );
