...
export const A2UI_PATH = "/__MrBeanBot__/a2ui";
export const CANVAS_HOST_PATH = "/__MrBeanBot__/canvas";
export const CANVAS_WS_PATH = "/__MrBeanBot/ws";
...
(() => {
  ...
  const handlerNames = ["MrBeanBotCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.MrBeanBot = globalThis.MrBeanBot ?? {};
  globalThis.MrBeanBot.postMessage = postToNode;
