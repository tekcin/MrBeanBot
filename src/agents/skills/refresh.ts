...
function resolveWatchPaths(workspaceDir: string, config?: MrBeanBotConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MrBeanBotConfig }) {
