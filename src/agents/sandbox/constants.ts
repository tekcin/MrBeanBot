...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".mrbeanbot", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "mrbeanbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "mrbeanbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "mrbeanbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "mrbeanbot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "mrbeanbot-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".mrbeanbot");
