...
function resolveAvatarSource(cfg: MrBeanBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MrBeanBotConfig, agentId: string): AgentAvatarResolution {
