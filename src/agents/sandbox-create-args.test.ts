  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "MrBeanBot.sandbox=1",
        "--label",
        "MrBeanBot.sessionKey=main",
        "--label",
        "MrBeanBot.createdAtMs=1700000000000",
        "--label",
        "MrBeanBot.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
