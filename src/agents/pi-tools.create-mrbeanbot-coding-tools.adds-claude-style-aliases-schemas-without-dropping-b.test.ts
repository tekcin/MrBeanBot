...
describe("createMrBeanBotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createMrBeanBotCodingTools({
      config,
    ...
    const anthropicTools = createMrBeanBotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createMrBeanBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createMrBeanBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
