...
import { resolveMrBeanBotDocsPath } from "../docs-path.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureMrBeanBotModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createMrBeanBotCodingTools({
      exec: {
    ...
    const docsPath = await resolveMrBeanBotDocsPath({
      workspaceDir: effectiveWorkspace,
