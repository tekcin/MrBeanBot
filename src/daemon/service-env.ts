...
export function buildServiceEnvironment(params: {
  ...
  const profile = env.MRBEANBOT_PROFILE;
  ...
  return {
    ...
    MRBEANBOT_PROFILE: profile,
    MRBEANBOT_STATE_DIR: env.MRBEANBOT_STATE_DIR,
    MRBEANBOT_CONFIG_PATH: env.MRBEANBOT_CONFIG_PATH,
    MRBEANBOT_GATEWAY_PORT: String(port),
    MRBEANBOT_GATEWAY_TOKEN: token,
    MRBEANBOT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    MRBEANBOT_SYSTEMD_UNIT: systemdUnit,
    MRBEANBOT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    MRBEANBOT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    MRBEANBOT_STATE_DIR: env.MRBEANBOT_STATE_DIR,
    MRBEANBOT_CONFIG_PATH: env.MRBEANBOT_CONFIG_PATH,
    MRBEANBOT_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    MRBEANBOT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    MRBEANBOT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    MRBEANBOT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    MRBEANBOT_LOG_PREFIX: "node",
    MRBEANBOT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    MRBEANBOT_SERVICE_KIND: NODE_SERVICE_KIND,
    MRBEANBOT_SERVICE_VERSION: VERSION,
  };
}
