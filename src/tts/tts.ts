...
export function resolveTtsConfig(cfg: MrBeanBotConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.MRBEANBOT_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: MrBeanBotConfig): string | undefined {
