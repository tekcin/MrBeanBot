...
${formatHelpExamples([
  ['MrBeanBot agent --to +15555550123 --message "status update"', "Start a new session."],
  ['MrBeanBot agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['MrBeanBot agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
