...
// package.json "MrBeanBot" metadata (used for onboarding/catalog)
...
export type MrBeanBotPackageManifest = {
  extensions?: string[];
...
): MrBeanBotPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.MrBeanBot ?? manifest[LEGACY_MANIFEST_KEY];
}
