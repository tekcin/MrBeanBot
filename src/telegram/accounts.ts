...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MRBEANBOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: MrBeanBotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: MrBeanBotConfig): string {
...
export function listEnabledTelegramAccounts(cfg: MrBeanBotConfig): ResolvedTelegramAccount[] {
