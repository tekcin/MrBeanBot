...
function resolveMentionPatterns(cfg: MrBeanBotConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: MrBeanBotConfig | undefined, agentId?: string): RegExp[] {
