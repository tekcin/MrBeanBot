import type { BrowserConfig, BrowserProfileConfig, MrBeanBotConfig } from "../config/config.js";
import {
 ...
 *
 * Note: this is a MrBeanBot browser profile (routing config), not a Chrome user profile.
