...
export type ChannelAgentToolFactory = (params: { cfg?: MrBeanBotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MrBeanBotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: MrBeanBotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: MrBeanBotConfig }) => boolean;
  supportsCards?: (params: { cfg: MrBeanBotConfig }) => boolean;
