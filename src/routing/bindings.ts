...
export function listBindings(cfg: MrBeanBotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: MrBeanBotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: MrBeanBotConfig) {
