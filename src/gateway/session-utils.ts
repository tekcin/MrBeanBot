...
import { type MrBeanBotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: MrBeanBotConfig): string[] {
...
export function listAgentsForGateway(cfg: MrBeanBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: MrBeanBotConfig): string {
...
function resolveSessionStoreAgentId(cfg: MrBeanBotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: MrBeanBotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: MrBeanBotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: MrBeanBotConfig): GatewaySessionsDefaults {
