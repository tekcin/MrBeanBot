...
import type { MrBeanBotConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: MrBeanBotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: MrBeanBotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: MrBeanBotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: MrBeanBotConfig) => void;
  log: {
