...
export const DEFAULT_LOG_DIR = "/tmp/mrbeanbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "mrbeanbot.log"); // legacy single-file path

const LOG_PREFIX = "mrbeanbot";
