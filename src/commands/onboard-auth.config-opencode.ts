...
export function applyOpencodeZenProviderConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyOpencodeZenConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
