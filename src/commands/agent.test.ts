...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "MrBeanBot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<MrBeanBotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<MrBeanBotConfig["telegram"]>>,
