...
const ensureMrBeanBotModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveMrBeanBotAgentDir = vi.fn().mockReturnValue("/tmp/MrBeanBot-agent");
