...
export async function updateConfig(
  mutator: (cfg: MrBeanBotConfig) => MrBeanBotConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: MrBeanBotConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: MrBeanBotConfig): Set<string> {
