...
export function applyZaiConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyOpenrouterProviderConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyOpenrouterConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyMoonshotProviderConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyKimiCodeProviderConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applySyntheticProviderConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: MrBeanBotConfig): MrBeanBotConfig {
