...
function resolveAnthropicDefaultAuthMode(cfg: MrBeanBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyTalkApiKey(config: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyModelDefaults(cfg: MrBeanBotConfig): MrBeanBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyLoggingDefaults(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyContextPruningDefaults(cfg: MrBeanBotConfig): MrBeanBotConfig {
...
export function applyCompactionDefaults(cfg: MrBeanBotConfig): MrBeanBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
