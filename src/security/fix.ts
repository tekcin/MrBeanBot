...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof MrBeanBotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: MrBeanBotConfig; env: NodeJS.ProcessEnv }): {
  cfg: MrBeanBotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
