...
declare global {
  interface Window {
    __MRBEANBOT_ASSISTANT_NAME__?: string;
    __MRBEANBOT_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__MRBEANBOT_ASSISTANT_NAME__,
    avatar: window.__MRBEANBOT_ASSISTANT_AVATAR__,
  });
}
