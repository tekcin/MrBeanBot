...
final class ScreenController {
    ...
    /// Callback invoked when a MrBeanBot:// deep link is tapped in the canvas
...
/// Handles navigation policy to intercept MrBeanBot:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept MrBeanBot:// deep links
        if url.scheme == "MrBeanBot" {
