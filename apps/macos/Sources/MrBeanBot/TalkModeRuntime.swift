...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.tekcin.mrbeanbot", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.tekcin.mrbeanbot", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MrBeanBotChatMessage] = messages.compactMap { item in
