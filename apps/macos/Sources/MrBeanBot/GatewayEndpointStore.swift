...
actor GatewayEndpointStore {
    ...
    private static let staticLogger = Logger(subsystem: "com.tekcin.mrbeanbot", category: "gateway-endpoint")
    ...
    private let logger = Logger(subsystem: "com.tekcin.mrbeanbot", category: "gateway-endpoint")
