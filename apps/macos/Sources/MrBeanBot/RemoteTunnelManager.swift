...
actor RemoteTunnelManager {
    ...
    private let logger = Logger(subsystem: "com.tekcin.mrbeanbot", category: "remote-tunnel")
    ...
    func controlTunnelPortIfRunning() async -> UInt16? {
        ...
        // If a previous MrBeanBot run already has an SSH listener on the expected port (common after restarts),
