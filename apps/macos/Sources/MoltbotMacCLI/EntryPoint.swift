...
struct MrBeanBotMacCLI {
    static func main() async {
        ...
        default:
            fputs("MrBeanBot-mac: unknown command\n", stderr)
            printUsage()
            exit(1)
        }
    }
...
private func printUsage() {
    ...
    Examples:
      ...
      MrBeanBot-mac connect --url ws://127.0.0.1:18789 --json
      MrBeanBot-mac discover --timeout 3000 --json
      MrBeanBot-mac wizard --mode local
    """)
}
