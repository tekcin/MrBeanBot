...
enum UIStrings {
    static let welcomeTitle = "Welcome to MrBeanBot"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: MrBeanBotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: MrBeanBotChatViewModel
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: MrBeanBotChatViewModel(
