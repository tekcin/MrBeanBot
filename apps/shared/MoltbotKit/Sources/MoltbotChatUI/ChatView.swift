...
@MainActor
public struct MrBeanBotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: MrBeanBotChatViewModel
    ...
    public init(
        viewModel: MrBeanBotChatViewModel,
    ...
    private var visibleMessages: [MrBeanBotChatMessage] {
        let base: [MrBeanBotChatMessage]
    ...
    private func mergeToolResults(in messages: [MrBeanBotChatMessage]) -> [MrBeanBotChatMessage] {
        ...
        for message in messages {
            ...
            let merged = MrBeanBotChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: MrBeanBotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: MrBeanBotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: MrBeanBotChatMessage) -> String {
