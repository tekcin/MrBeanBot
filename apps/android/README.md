## MrBeanBot Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_MrBeanBot-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm MrBeanBot gateway --port 18789 --verbose
```
