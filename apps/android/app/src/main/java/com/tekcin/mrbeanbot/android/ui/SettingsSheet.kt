...
import com.tekcin.mrbeanbot.android.LocationMode
import com.tekcin.mrbeanbot.android.MainViewModel
import com.tekcin.mrbeanbot.android.NodeForegroundService
import com.tekcin.mrbeanbot.android.VoiceWakeMode
import com.tekcin.mrbeanbot.android.WakeWords
  ...
  LazyColumn(
      ...
      AnimatedVisibility(visible = voiceWakeMode != VoiceWakeMode.Off) {
        Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
          ListItem(
            ...
            supportingContent = { Text("Listens only while MrBeanBot is open.") },
            trailingContent = {
              RadioButton(
    ...
    item {
      Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
        ...
        ListItem(
          ...
          supportingContent = { Text("Only while MrBeanBot is open.") },
          trailingContent = {
            RadioButton(
    ...
    item {
      ListItem(
        ...
        supportingContent = { Text("Keeps the screen awake while MrBeanBot is open.") },
