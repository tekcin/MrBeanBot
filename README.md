...
Minimal `~/.MrBeanBot/mrbeanbot.json` (model + defaults):
...
- Link the device: `pnpm mrbeanbot channels login` (stores creds in `~/.MrBeanBot/credentials`).
