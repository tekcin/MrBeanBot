...
### Changes
- Version alignment with core MrBeanBot release numbers.
...
### Highlights
- First public release of the @MrBeanBot/voice-call plugin.
...
- CLI: `MrBeanBot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
