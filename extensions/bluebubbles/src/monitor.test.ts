...
import { removeAckReactionAfterReply, shouldAckReaction } from "MrBeanBot/plugin-sdk";
import type { MrBeanBotConfig, PluginRuntime } from "MrBeanBot/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/mrbeanbot") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
