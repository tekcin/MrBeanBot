...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: typeof import("MrBeanBot/plugin-sdk")["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    typeof import("MrBeanBot/plugin-sdk")["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "MrBeanBot: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
