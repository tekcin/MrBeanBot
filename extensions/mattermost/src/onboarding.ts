import type { ChannelOnboardingAdapter, MrBeanBotConfig, WizardPrompter } from "MrBeanBot/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.mrbeanbot.com/channels/mattermost",
    ].join("\n"),
