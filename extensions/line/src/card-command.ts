import type { MrBeanBotPluginApi, LineChannelData, ReplyPayload } from "MrBeanBot/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: MrBeanBotPluginApi): void {
  api.registerCommand({
    name: "card",
