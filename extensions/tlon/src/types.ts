...
export function resolveTlonAccount(cfg: MrBeanBotConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: MrBeanBotConfig): string[] {
  const base = cfg.channels?.tlon as
